...
Τέλος, ήθελα όταν γίνεται η αναγνώριση του, να εμφανίζει το url του προσωπικού μου λογαριασμού στο Github σε νέα καρτέλα. Τροποποίσησα λοιπόν το παράδειγμα `QRCodeExample` και το **Decode** του qr code γίνεται με το `πλήκτρο space`
![Screenshot (8)](https://user-images.githubusercontent.com/100956280/199737428-67db5b66-1856-4f29-ae32-eec663b6b7f4.png)
